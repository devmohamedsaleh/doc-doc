...
mixin _$SpecializationModel {
 ...
 int get id; String get name; List<DoctorModel> get doctors;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SpecializationModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other.doctors, doctors));
}
...
@override
String toString() {
  return 'SpecializationModel(id: $id, name: $name, doctors: $doctors)';
}
...
@useResult
$Res call({
 int id, String name, List<DoctorModel> doctors
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  List<DoctorModel> doctors)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SpecializationModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  List<DoctorModel> doctors)  $default,) {final _that = this;
switch (_that) {
case _SpecializationModel():
return $default(_that.id,_that.name,_that.doctors);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  List<DoctorModel> doctors)?  $default,) {final _that = this;
switch (_that) {
case _SpecializationModel() when $default != null:
return $default(_that.id,_that.name,_that.doctors);case _:
  return null;
...
class _SpecializationModel implements SpecializationModel {
  const _SpecializationModel({required this.id, required this.name, required final  List<DoctorModel> doctors}): _doctors = doctors;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SpecializationModel&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&const DeepCollectionEquality().equals(other._doctors, _doctors));
}
